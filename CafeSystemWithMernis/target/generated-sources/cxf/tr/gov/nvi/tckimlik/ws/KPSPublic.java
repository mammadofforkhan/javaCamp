 ...
 * 2021-05-05T20:59:22.811+04:00
 * Generated source version: 3.4.3
 *
 */
@WebServiceClient(name = "KPSPublic",
                  wsdlLocation = "file:/C:/javaCamp/CafeSystemWithMernis/src/main/resources/Mernis.wsdl",
...
public class KPSPublic extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/javaCamp/CafeSystemWithMernis/src/main/resources/Mernis.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(KPSPublic.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/javaCamp/CafeSystemWithMernis/src/main/resources/Mernis.wsdl");
        }
        WSDL_LOCATION = url;
    }
